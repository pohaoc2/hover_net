Colab example Po-Hao created to segment cells (no type) [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/pohaoc2/hover_net/blob/chiu/master/hovernet_infer.ipynb)
